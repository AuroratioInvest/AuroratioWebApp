    ...
    <footer className="public-footer">
      ...
      <div className="public-footer__grid">
        ...
        >
          ...
          <p className="public-footer__brand"><span>{companyInformation.brandName_p1}</span>{companyInformation.brandName_p2}</p>
        ...
        >
          ...
          <ul className="public-footer__links">
            ...
            <li><Link to="/platform">{text.methodology}</Link></li>
            <li><Link to="/performance">{text.research}</Link></li>
      ...
      <p className="public-footer__copyright">
        © {currentYear} {companyInformation.brandName}. {text.rights}
      </p>
    </footer>
  );
}
